...
internal data class StatisticEntity(
    ...
    fun toModel(): StatisticModel = StatisticModel(id, startTime, totalDistance, averageSpeed, currentSpeed, lifecycle)
}

internal fun StatisticModel.toEntity(): StatisticEntity = StatisticEntity(id, startTime, totalDistance, averageSpeed, currentSpeed, lifecycle)
